...
Known baseline: collector has 189 green pytest tests + a clean mypy run across 70
files. web has 1104 green vitest tests across 50 suites. If either green count
