...
const DESCRIPTION =
  "تابلو قیمت خرید و فروش طلا و سکه را از چند منبع کنار هم می‌گذارد تا اختلاف قیمت‌ها، کارمزدها و تازگی داده‌ها شفاف‌تر دیده شود.";
  ...
  return (
    <PageShell>
      ...
      <article className="glass-surface px-5 py-7 text-[15px] leading-8 text-foreground/90 sm:px-8 sm:py-9">
        ...
        <p className="mt-5">
          بازار آنلاین طلا برای کاربر عادی همیشه یک عدد ساده نیست. قیمت خرید، قیمت فروش، کارمزد،
          وضعیت باز یا بسته بودن خرید و فروش، و زمان ثبت داده می‌تواند بین منابع مختلف فرق داشته
          باشد. تابلو این داده‌ها را کنار هم می‌گذارد تا کاربر قبل از تصمیم‌گیری، تصویر روشن‌تری از
          اختلاف قیمت‌ها داشته باشد.
        </p>
