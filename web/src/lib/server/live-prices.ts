 ...
 * اینجا نیست (قاعده‌ی ۱ قراردادها) و `price_display` عین رشته‌ی fa-IR سلول
 * قیمت صفحه است، تا سوآپ کلاینت هیچ قالب‌بندی مستقلی نسازد.
 *
...
import { displayPriceToman } from "../rows";
