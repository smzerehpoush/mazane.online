...
from .bonbast import BonbastReference
...
# فهرست مراجع نسخه‌ی ۱ (بند ۱۲.۲) — دو تا، و هیچ‌کدام در PLATFORMS نیست.
REFERENCE_SOURCES: tuple[ReferenceSource, ...] = (TalairReference(), BonbastReference())
