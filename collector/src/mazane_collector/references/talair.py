...
فیلدهای ذخیره‌شده (دامنه‌ی بلیت ۵: بازار تهران آب‌شده + انس جهانی):

- `gold.gold_18k`      ⟸ GOLD_18K_TOMAN (تومان بر گرم، ×۱)
- `gold.gold_bazaruser`⟸ ABSHODE_MITHQAL_TOMAN («مظنه بازار تهران»، ×۱)
- `gold.gold_ounce`    ⟸ XAU_USD (دلار بر اونس، ×۱)
"""
...
_FIELD_TO_INSTRUMENT = {
    ...
    "gold_bazaruser": ReferenceInstrument.ABSHODE_MITHQAL_TOMAN,
    "gold_ounce": ReferenceInstrument.XAU_USD,
}
