...
- **اسپرد صفر** (بند ۳.۴): دو قیمت دقیقاً برابرند و کارمزد جدا گرفته
  ...
  ⚠️ اینجا `IMPLIED` **غلط** می‌بود: اسپرد صفر است، پس کارمزد استنتاجی صفر
  در می‌آمد و «ملی‌گلد کارمزد نمی‌گیرد» ادعای نادرستی است. تهی یعنی
  نمی‌دانیم؛ صفر یعنی می‌دانیم کارمزدی نیست (CONTEXT.md، «کارمزد نامعلوم»).
